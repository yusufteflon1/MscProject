    ...
    selectors.forEach((item, index) => {
        ...
        function singleSelect(){
            ...
            <div class="directorist-select__label">
                ...
                <span class="directorist-select__label--icon"><img src="assets2/svg/angle-down-solid.svg" alt=""></span>
            </div>
            ...
            option.forEach((el, index) => {
                ...
                if(el.hasAttribute('selected')){
                    selectTrigger.innerHTML = el.innerHTML +'<img src="assets2/svg/angle-down-solid.svg" alt="">';
                };
            });
            ...
            selectTrigger.addEventListener('click', (e) => {
                ...
                li.forEach((el, index) => {
                    el.addEventListener('click', (event) => {
                        ...
                        sibling.querySelector('.directorist-select__dropdown').classList.remove('directorist-select__dropdown-open');
                        item.querySelector('.directorist-select__label').innerHTML = el.querySelector('.directorist-select-dropdown-text').textContent +'<img src="assets2/svg/angle-down-solid.svg" alt="">';
                    });
                });
            });
