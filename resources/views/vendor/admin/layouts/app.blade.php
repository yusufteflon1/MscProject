...
<head>
    ...
    <title>{{ __('Abuja Enterprise Agency') }} - {{ $title ?? __('Home') }}</title>
            ...
            <div class="navbar-header" data-logobg="skin6">
                ...
                <div class="navbar-brand">
                    <a href="@route(getRouteName().'.home')">
                        <span class="logo-text">{{ __('AEA') }}</span>
                    </a>
                </div>
                <!-- End Logo -->
...
<!-- End Left Sidebar -->
    ...
    <div class="page-wrapper">
        ...
        <!-- footer -->
        <footer class="footer text-center text-muted">Abuja Enterprise Agency <a href="https://aea.org.ng"></a> CRM APP</footer>
        <!-- End footer -->
    </div>
</div>
<!-- End Wrapper -->
