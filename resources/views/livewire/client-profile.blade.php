<x-app-layout>
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        ...
        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">ab galla</dd>
        </div>
        ...
        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">abgalla.gmail.com</dd>
        </div>
        <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
        <dt class="text-sm font-medium text-gray-500">Telephone number</dt>
        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">0999383838</dd>
        </div>
        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
