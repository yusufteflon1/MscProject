...
<div class="content-center">
    <div class="flex items-center justify-center min-h-screen bg-gray-100">
        <div class="px-8 py-6 mt-4 text-left bg-white shadow-lg">
            <div class="flex justify-center content-center text-xl font-semibold">{{ __('Register') }}</div>
            <div class="flex justify-center content-center pb-3 pt-3">
                <img src="{{ asset('assets2/images/logo.png') }}" height="110" width="130" viewbox="0 0 48 48" alt="logo">
            </div>
                    <div class=" flex justify-center content-center pt-3">
                        ...
                        <button type="button" class="text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
                            ...
                            <a href="{{route('loginUsingGoogle') }}">Sign in with Google</a>
                          </button>
                     </div>
                </div>
            </div>
