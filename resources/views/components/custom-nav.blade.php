        <div {{ $attributes->merge(['class' => 'h-screen hidden lg:block shadow-lg relative w-80']) }} >
            <div class="bg-white h-full bg-green-900">
                <div class="flex items-center justify-start pt-6 ml-8">
                    <p class="font-bold dark:text-white text-xl">
                        <x-application-logo class="block h-20 w-auto fill-current" ></x-application-logo>
                    </p>
                </div>
                <nav class="mt-6">
                    <div>
                        ...
                        <a class="w-full text-gray-400 flex items-center pl-6 p-2 my-2 transition-colors duration-200 justify-start hover:text-gray-800 border-l-4 border-transparent" href="#">
                            ...
                            <span class="mx-2 text-sm font-normal">
                                Refered Projects
                                <span class="p-1 ml-4 rounded-lg w-4 h-2 bg-green-200 text-gray-400 text-xs">
                                    0
                                </span>
                            </span>
                        </a>
